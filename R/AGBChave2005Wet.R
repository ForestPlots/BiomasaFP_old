...
#' 
#' @description Function to estimate individual biomass using Chave (2005) equation for wet forests.The function adds columns to the dataset with the biomass information for all alive trees.
