...
#' @description This function produces a biomass change output between first and last census by PlotViewID. AGB is estimated by providing a biomass equation from the ones included in the package.
